...
export const scopeLabels: Record<LanguageScope, { zh: string; en: string }> = {
  ...
  library: { zh: "比赛录像库", en: "Round library" },
...
const entries: Entry[] = [
  ...
  { source: "参考比赛录像库中的优秀比赛录像 →", en: "Open exemplary rounds in the library →" },
  ...
  { source: "共享文档集中保存 case 正文与结构化证据；工作区成员可在同一份资料上协作。", en: "Shared documents keep case text and structured Evidence together for workspace collaboration." },
  { source: "保存并进入编辑", en: "Save and open editor" },
  { source: "创建中...", en: "Creating..." },
  { source: "取消", en: "Cancel" },
  ...
  { source: "文档工作台：左侧维护正文，右侧选择、编辑或导入这份文档的证据。", en: "Document workbench: edit the body on the left and manage this document's Evidence on the right." },
  { source: "返回文档列表", en: "Back to documents" },
  { source: "已保存", en: "Saved" },
  { source: "有未保存改动", en: "Unsaved changes" },
  { source: "文档内容", en: "Document content" },
  { source: "保存文档", en: "Save document" },
  { source: "正文", en: "Body" },
  { source: "粘贴 case text、blocks 或研究笔记...", en: "Paste case text, blocks, or research notes..." },
  { source: "所有文档改动已保存。", en: "All document changes are saved." },
  { source: "证据工作区", en: "Evidence workspace" },
  { source: "证据操作", en: "Evidence actions" },
  { source: "选中编辑", en: "Edit selected" },
  { source: "新增证据", en: "New Evidence" },
  { source: "批量导入", en: "Batch import" },
  { source: "来源链接", en: "Source URL" },
  { source: "作者 / 机构", en: "Author / organization" },
  { source: "刊物 / 报告", en: "Publication / report" },
  { source: "发布日期", en: "Published date" },
  { source: "保存证据", en: "Save Evidence" },
  { source: "删除证据", en: "Delete Evidence" },
  { source: "添加证据", en: "Add Evidence" },
  { source: "当前为只读访问。", en: "This document is read-only." },
  { source: "这份文档还没有证据。", en: "This document has no Evidence yet." },
  { source: "文档证据列表", en: "Document Evidence" },
  { source: "保存中...", en: "Saving..." },
  { source: "证据改动已保存。", en: "Evidence changes are saved." },
  { source: "证据已删除。", en: "Evidence deleted." },
  { source: "确定删除这条证据吗？已关联比赛中的引用也会被移除。", en: "Delete this Evidence card? Its existing match links will also be removed." },
  { source: "证据范围", en: "Evidence scope" },
  { source: "当前工作区", en: "Current workspace" },
  { source: "全站证据", en: "All Evidence" },
